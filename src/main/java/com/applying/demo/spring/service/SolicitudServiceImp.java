...
public class SolicitudServiceImp implements SolicitudService {
	...
	static {
		...
		solicitudes.add(new SolicitudBean(1l,10l,"Comisaria San Juan", 13200124l,"Antony Jefferson",1l,"REGISTRADO"));
		solicitudes.add(new SolicitudBean(2l,11l,"Comisaria Miraflores", 13200124l,"Antony Jefferson",1l,"REGISTRADO"));
		solicitudes.add(new SolicitudBean(3l,12l,"Comisaria Cercado", 13200117l,"Luis Ramiro",1l,"REGISTRADO"));
		solicitudes.add(new SolicitudBean(4l,13l,"Comisaria Breña", 13200116l,"Ricardo Fabrizzio",1l,"REGISTRADO"));
	}
	...
	//////1
	public List<SolicitudBean> listadodeSolicitudesxPersona(Long id) {
		//return (List<SolicitudBean>) solicitudes.stream().filter()
		return solicitudes;
		//return null;
	}
