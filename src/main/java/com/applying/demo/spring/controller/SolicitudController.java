...
public class SolicitudController {
	...
	@GetMapping("/vistaSolicitudes/{id}")
	public String userForm(@PathVariable(value="id" ,required=false) Long personaId,Model model,Locale locale) {
		model.addAttribute("solicitudes", solicitudService.listadodeSolicitudesxPersona(personaId));
